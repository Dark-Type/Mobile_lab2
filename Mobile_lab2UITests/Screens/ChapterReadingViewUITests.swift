...
class ChapterReadingViewUITests: XCTestCase {
    ...
    func testChaptersPanel() throws {
        ...
        if buttonsInChaptersList.count > 0 {
            ...
            if potentialChapterButtons.count > 0 {
                ...
                if allButtonsExceptClose.count > 0 {
    ...
    func testQuoteAddition() throws {
        ...
        XCTAssertFalse(quoteTextEditor.value as! String == "", "Quote text editor should contain selected text")
        ...
        let expectation = XCTestExpectation(description: "Quote overlay should close")
        DispatchQueue.main.asyncAfter(deadline: .now() + 1) {
            expectation.fulfill()
        }
