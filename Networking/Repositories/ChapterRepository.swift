...
protocol ChapterRepositoryProtocol: Sendable {
...
final class ChapterRepository: ChapterRepositoryProtocol, @unchecked Sendable {
    ...
    init(service: ChapterServiceProtocol) {
